...
- [send a message](https://docs.notifications.service.gov.uk/net.html#send-a-message)
- [get message status](https://docs.notifications.service.gov.uk/net.html#get-message-status)
- [get a template](https://docs.notifications.service.gov.uk/net.html#get-a-template)
- [get received text messages](https://docs.notifications.service.gov.uk/net.html#get-received-text-messages)
