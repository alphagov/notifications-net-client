...
namespace Notify.Interfaces
{
    public interface IAsyncNotificationClient : IBaseClient
    {
        ...
        Task<EmailNotificationResponse> SendEmailAsync(string emailAddress, string templateId, Dictionary<string, dynamic> personalisation = null, string clientReference = null, string emailReplyToId = null, string unsubscribeLink = null);
